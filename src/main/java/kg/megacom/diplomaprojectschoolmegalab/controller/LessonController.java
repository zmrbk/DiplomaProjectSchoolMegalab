...
public class LessonController {
    ...
    @PostMapping
    public ResponseEntity<Response<Void>> createLesson(@RequestBody LessonDto lessonDto) {
        log.info("[#createLesson] is calling");
        lessonService.create(lessonDto);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(new Response<>("Lesson created successfully", null));
    }

    @GetMapping
    public ResponseEntity<Response<List<LessonDto>>> getAllLessons() {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Response<LessonDto>> getLessonById(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Response<LessonDto>> updateLesson(@PathVariable Long id,
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Response<Void>> deleteLesson(@PathVariable Long id) {
